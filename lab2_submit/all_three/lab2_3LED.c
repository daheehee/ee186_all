...
int main(void)
{
	...
	*gpioC_mode &= ~(0b11 << 26) + ~(0b11 << 14);
	*gpioC_mode |= 1 << 14;
	*gpioB_mode &= ~(0b11 << 14) + ~(0b11 << 28);
	*gpioB_mode |= (0b01 << 14) + (0b01 << 28);

	*gpioC_type &= ~(0b01 << 7);
	*gpioB_type &= ~(0b01 << 7) + ~(0b01 << 14);

	*gpioC_speed |= (0b11 << 26) + (0b11 << 14);
	*gpioB_speed |= (0b11 << 14) + (0b11 << 28);

	*gpioC_pull &= ~(0b11 << 26) + ~(0b11 << 14);
	*gpioB_pull &= ~(0b11 << 14) + ~(0b11 << 28);

	*gpioB_set &= ~(0b01 << 7) + ~(0b01 << 14);
	*gpioB_set |= (0b01 << 7) + (0b01 << 14);
	*gpioC_set &= ~(0b01 << 13) + ~(0b01 << 7);
	*gpioC_set |= (0b01 << 13) + (0b01 << 7);

	*gpioB_out &= ~(0b01 << 7) + ~(0b01 << 14);
	*gpioC_out &= ~(0b01 << 7);
